        ...
        >
          <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
              ...
              <motion.span variants={variants}>
                erickpjoshy@gmail.com
              </motion.span>
            </motion.div>
            <motion.div className="item" variants={variants}>
              <motion.h2 variants={variants}>Adress</motion.h2>
              <motion.span variants={variants}>
                Poruthukkaran house,chevoor,TCR
              </motion.span>
            </motion.div>
            <motion.div className="item" variants={variants}>
              <motion.h2 variants={variants}>Phone</motion.h2>
              <motion.span variants={variants}>+91 6282634660</motion.span>
            </motion.div>
          </motion.div>
          <div className="formContainer">
            ...
            >
              ...
              <button className={`${success ? 'hide' : 'display'}`}>
                Submit
              </button>
              <div className={`${success ? 'display' : 'hide'} label-style`}>
                <label>Your submission has been sent</label>
              </div>
            </motion.form>
          </div>
        </motion.div>
